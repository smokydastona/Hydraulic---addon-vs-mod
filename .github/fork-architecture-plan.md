...
- Current runtime bridges already include explicit metadata-backed menu fallback, block-entity patch translation, and entity interaction prompt translation at real Geyser seams.
...
2. consume the new typed runtime bridge categories in additional bridge factories and dispatch tables so transfer-heavy, fluid, and richer behavior paths stop depending on ad hoc requirement-string interpretation
