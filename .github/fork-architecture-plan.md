...
- Runtime diagnostics now consume typed bridge-group queries for menu and block-entity candidate selection, and fluid presentation now has a first real bucket-item consumer, but the broader machine, transfer, and fluid execution paths still do not have real bridge implementations.
