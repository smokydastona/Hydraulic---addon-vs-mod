...
2. extend the shipped explicit processing-input block-use mutation to additional slot, tank, energy, or property actions only when the compiled plan provides concrete semantics
