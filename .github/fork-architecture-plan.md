...
- Resource-pack reading and broader resource resolution are still too eager even though startup model lookup, custom model conversion, and selective texture extraction now use indexed mod paths.
