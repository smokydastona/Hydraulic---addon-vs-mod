...
2. extend rich menu and block-entity behavior on top of transaction-backed state changes and transport-aware synchronization results
3. expand automatic Java recipe discovery into compiled mixed-resource machine process facts beyond metadata-provided recipe contracts
